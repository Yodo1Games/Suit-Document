...
You can obtain the MAS [Impression-Level User Revenue] (https://developers.yodo1.com/docs/sdk/guides/unity/ad-formats#impression-level-user-revenue-1). The sample code for reporting revenue is as follows
